...
rows = []
with open("my_1to40agents_250iterations_40x40_new.csv", "r") as f:
    csvreader = csv.reader(f)
...
rows = []
with open("my_1to40agents_250iterations_40x40_v2_anomaly_4.csv", "r") as f:
    csvreader = csv.reader(f)
...
plt.title('(2) Our algorithm - 1 interval vs. 2 intervals - 40-by-40 maze')
